CREATE TABLE `organization_grade` (
                                      ...
                                      `code` varchar(100) NOT NULL DEFAULT '' COMMENT '组织类型编码',
                                      ...
                                      PRIMARY KEY (`id`),
                                      KEY `path` (`path`(191))
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='组织类型';

=@=@=@=@=@=

INSERT INTO `organization_grade` (`id`, `pid`, `path`, `len`, `code`, `name`, `name_en`, `description`, `extends`, `sort`, `admin_role_id`, `created_at`, `updated_at`, `deleted_at`)
VALUES
	(1, 0, '0,1', 1, '', '系统', 'system', '', '', 0, 1, '2021-08-01 12:00:00', '2021-08-01 12:00:00', NULL);
