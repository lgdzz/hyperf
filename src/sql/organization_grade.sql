...
INSERT INTO `organization_grade` (`id`, `pid`, `path`, `len`, `name`, `name_en`, `description`, `sort`, `created_at`, `updated_at`)
VALUES
	(1, 0, '0,1', 1, '系统', 'system', '', 0, '2021-08-01 12:00:00', '2021-08-01 12:00:00');
