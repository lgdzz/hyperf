CREATE TABLE `role` (
                        ...
                        `extends` varchar(2000) NOT NULL DEFAULT '' COMMENT '扩展对象',
                        `rules` varchar(2000) NOT NULL DEFAULT '' COMMENT '所有权限',
                        `half_rules` varchar(2000) NOT NULL DEFAULT '' COMMENT '能授权不能使用',
...
INSERT INTO `role` (`id`, `pid`, `org_id`, `path`, `name`, `master`, `status`, `is_system`, `remark`, `extends`, `rules`, `half_rules`, `created_at`, `updated_at`)
VALUES
	(1, 0, 1, '0,1', '系统管理员', 1, 1, 1, '系统默认角色', '{\"type\":\"gl\"}', '[]', '', '2021-07-06 12:00:00', '2021-07-06 12:00:00');
